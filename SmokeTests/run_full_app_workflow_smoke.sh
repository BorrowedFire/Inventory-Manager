...
BUILD_CACHE="/tmp/inventory-manager-full-app-smoke-cache"
SMOKE_BIN="/tmp/inventory_manager_full_app_workflow_smoke"
...
swiftc \
  ...
  "$ROOT/SmokeTests/full_app_workflow_smoke.swift" \
  -o "$SMOKE_BIN"
